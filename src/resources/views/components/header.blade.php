    ...
    <div class="header-top">
        <div class="container">
            <div class="header-left">
                <a href="tel:#"><i
                        class="icon-phone"></i>0966093980</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </div><!-- End .header-left -->
            <div class="header-left">
                <a href="tel:#"><i class="icon-envelope"></i>tienanh031102@gmail.com</a>
            </div><!-- End .header-left -->
        ...
        <div class="container">
            <div class="header-left">
                ...
                <a href="" class="logo" style="text-align: center; display: block;">
                    <img src="{{ asset('UserLTE/assets/images/icons/Logo_thuonghieu.png') }}" alt="Molla Logo"
                        width="50" height="10 " style="border-radius: 50%; margin: 0 auto;">
                    <p style="margin: 0; color: rgba(255, 255, 255, 0.864)"><b>Tran Tien Anh</b></p>
                    <p style="margin: 0; color: rgba(255, 255, 255, 0.864)"><b>Fishing Shop</b></p>
                </a>
    ...
    <div class="header-bottom sticky-header">
        <div class="container">
            ...
            <div class="header-right">
                ...
                <p>TRAN TIEN ANH Fishing Shop</p>
            </div>
        </div><!-- End .container -->
